...
gs13 = GasStation.create!(name: 'SOBRAL & PALACIO PETROLEO LTDA', address: 'AVENIDA PADRE ANTÔNIO TOMAZ, 945, Fortaleza', brand: 'RAIZEN')
...
gs16 = GasStation.create!(name: 'LEITE LEITE COMÉRCIO DE COMBUSTÍVEIS LTDA.', address: 'AVENIDA ANTONIO SALES, 902, Fortaleza', brand: 'SP')
...
gs25 = GasStation.create!(name: 'J C COMERCIO DE COMBUSTIVEL LTDA', address: 'AVENIDA ANTONIO JUSTA, 2400, Fortaleza', brand: 'IPIRANGA')
...
gs29 = GasStation.create!(name: 'ORGANIZACAO HELIO MEIRELES PETROLEO LTDA', address: 'AVENIDA ANTONIO SALES, 1340, Fortaleza', brand: 'PETROBRAS')
...
gs34 = GasStation.create!(name: 'UNIVERSO PETRÓLEO LTDA', address: 'AVENIDA VISCONDE DO RIO BRANCO, 3675, Fortaleza', brand: 'RAIZEN')
...
gs42 = GasStation.create!(name: 'DISTRIBUIDORA CANAA DE COMBUSTIVEIS LTDA', address: 'AVENIDA ANTONIO SALES 2880, Fortaleza', brand: 'IPIRANGA')
